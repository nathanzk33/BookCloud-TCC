<?php
/**
 * Script UNIFICADO para inserir TODOS os livros no banco de dados
 * Execute este arquivo UMA VEZ para garantir que todos os livros estejam no banco
 */
...
try {
    foreach ($todosLivros as $livro) {
        // Se for livro extra, mapear categoria
    ...
    echo "📚 Livros inseridos: $inseridos<br>";
    echo "🔄 Livros atualizados: $atualizados<br>";
    echo "📖 Total de livros disponíveis: $total<br>";
    echo "<br><a href='catalogo.php'>Ver Catálogo</a>";
